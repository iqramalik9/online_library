    ...
    <div id="container">
        ...
        <h3>Alpha Read</h3>
                <p>World's biggest E library providing you with a bundle of books from all around the World.
                    ...
                    <h3>Getting to Know Alpha Read</h3>
                    <p> We at Alpha Read are trying to provide you with knowledge from all aorund the world. 
                    We have Gathered a number of books for you. They include books from different authors and countries. 
                    You can get Access to these books using our website and can have them in PDF format</p>
        </div>
            <div class="image">
