...
<body>
  ...
  ?>
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="do_signin_user.php" method="post" id="formname">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text"  placeholder="Username" name="name">
          ...
          <button type="submit" class="login100-form-btn" id ="btn-success" form="formname" value="Submit">
				...
				<div class="anchor">
				<a href="signin_admin.php">Sign In As Admin</a>
			</div>
			</div>
